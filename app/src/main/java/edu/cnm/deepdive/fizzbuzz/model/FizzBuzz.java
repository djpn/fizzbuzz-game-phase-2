 ...
 * return <code>boolean</code> and {@link String} results indicating whether the specified values
 * are divisible by 3 or 5 returning fizz or buzz, respectively</p>
 *
 * @author David JP Nelson &amp; Deep Dive Coding Java+Android Cohort 7.
 * @version 1.0.0.0
 */
public class FizzBuzz {
   ...
   * depending on whether the <code>value</code> is divisible by 3 or 5.
   *
   * @param value Integer <code>value</code> to be tested for divisibility by 3 or 5.
   * @return "Fizz", "Buzz", or <code>value</code> as a {@link String}.
   */
   ...
   *
   * @param value Integer <code>value</code> to be tested.
